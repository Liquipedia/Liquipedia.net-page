...
?>
	...
	<body>
		...
		<header class="header header--top">
            <div class="container">
                <svg class="header__logo logo" viewBox="0 0 2560 490" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="container">
                ...
                <div class="footer__group">
                    <ul class="footer__links">
                        ...
                        <li><a href="/counterstrike/Liquipedia:Privacy_policy" class="mw-redirect" title="Liquipedia:Privacy policy">Privacy policy</a></li>
                    </ul>
