	...
	<body class="column-<?php echo $col_number; ?>">
		...
		<div class="whitebox">
			<div class="content how-to">
				...
				<p>If you feel comfortable with wiki editing or if you want to learn things that are more advanced, feel free to browse our &quot;How to contribute&quot; sections you can find in the menus on the left of the wiki pages. You can find us on our Discord server where other contributors can help you. <a href="http://liquipedia.net/discord" target="_blank">Find us on Discord</a>.</p>
